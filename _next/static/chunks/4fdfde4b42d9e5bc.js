(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 62198, t => {
    "use strict";
    let e, s, i;
    t.i(47167);
    ...
    let y = "function" == typeof ArrayBuffer,
        ...
        g = (t, e) => y ? _((t => {
            ...
            let c = new ArrayBuffer(e),
                l = new Uint8Array(c);
            for (i = 0; i < s; i += 4) n = f[t.charCodeAt(i)], o = f[t.charCodeAt(i + 1)], a = f[t.charCodeAt(i + 2)], h = f[t.charCodeAt(i + 3)], l[r++] = n << 2 | o >> 4, l[r++] = (15 & o) << 4 | a >> 2, l[r++] = (3 & a) << 6 | 63 & h;
            return c
        })(t), e) : {
            base64: !0,
            data: t
        },
        _ = (t, e) => "blob" === e ? t instanceof Blob ? t : new Blob([t]) : t instanceof ArrayBuffer ? t : t.buffer;
    ...
    function v(t, e) {
        ...
        let s = new Uint8Array(e),
            i = 0;
        for (let r = 0; r < e; r++) s[r] = t[0][i++], i === t[0].length && (t.shift(), i = 0);
    ...
    k.prototype.on = k.prototype.addEventListener = function(t, e) {
        ...
        for (var e = Array(arguments.length - 1), s = this._callbacks["$" + t], i = 1; i < arguments.length; i++) e[i - 1] = arguments[i];
        if (s) {
            s = s.slice(0);
    ...
    let w = "function" == typeof Promise && "function" == typeof Promise.resolve ? t => Promise.resolve().then(t) : (t, e) => e(t, 0),
    ...
    function R(t, e) {
        e.useNativeTimers ? (t.setTimeoutFn = T.bind(E), t.clearTimeoutFn = O.bind(E)) : (t.setTimeoutFn = E.setTimeout.bind(E), t.clearTimeoutFn = E.clearTimeout.bind(E))
    }
    ...
    class S extends k {
        constructor(t) {
            super(), this.writable = !1, R(this, t), this.opts = t, this.query = t.query, this.socket = t.socket, this.supportsBinary = !t.forceBase64
        }
        onError(t, e, s) {
        ...
        onData(t) {
            let e = m(t, this.socket.binaryType);
            this.onPacket(e)
        }
        onPacket(t) {
    ...
    class x extends S {
        ...
        write(t) {
            ...
            }, i = Array(s = t.length), r = 0, t.forEach((t, n) => {
                l(t, !1, t => {
        ...
        uri() {
            let t = this.opts.secure ? "https" : "http",
                e = this.query || {};
            return !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = C()), this.supportsBinary || e.sid || (e.b64 = 1), this.createUri(t, e)
        }
    }
    let N = !1;
    try {
    ...
    class j extends k {
        constructor(t, e, s) {
            super(), this.createRequest = t, R(this, s), this._opts = s, this._method = s.method || "GET", this._uri = e, this._data = void 0 !== s.data ? s.data : null, this._create()
        }
        _create() {
            var t;
            let e = A(this._opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
            ...
            "undefined" != typeof document && (this._index = j.requestsCount++, j.requests[this._index] = this)
        }
        _onError(t) {
        ...
        _cleanup(t) {
            if (void 0 !== this._xhr && null !== this._xhr) {
                if (this._xhr.onreadystatechange = q, t) try {
                    this._xhr.abort()
                } catch (t) {}
                "undefined" != typeof document && delete j.requests[this._index], this._xhr = null
            }
        }
        _onLoad() {
    ...
    j.requestsCount = 0, j.requests = {}, "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", U) : "function" == typeof addEventListener && addEventListener("onpagehide" in E ? "pagehide" : "unload", U, !1));
    let D = (i = I({
        xdomain: !1
    })) && null !== i.responseType;
    ...
    function I(t) {
        let e = t.xdomain;
        try {
            if ("undefined" != typeof XMLHttpRequest && (!e || L)) return new XMLHttpRequest
        } catch (t) {}
        if (!e) try {
            return new E[["Active"].concat("Object").join("X")]("Microsoft.XMLHTTP")
        } catch (t) {}
    }
    let V = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
    class F extends S {
        get name() {
            return "websocket"
        }
        doOpen() {
            let t = this.uri(),
                ...
                s = V ? {} : A(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        ...
        uri() {
            let t = this.opts.secure ? "wss" : "ws",
                e = this.query || {};
            return this.opts.timestampRequests && (e[this.opts.timestampParam] = C()), this.supportsBinary || (e.b64 = 1), this.createUri(t, e)
        }
    }
    let M = E.WebSocket || E.MozWebSocket,
        H = {
            websocket: class extends F {
                createSocket(t, e, s) {
                    return V ? new M(t, e, s) : e ? new M(t, e) : new M(t)
                }
                doWrite(t, e) {
                    this.ws.send(e)
                }
                ...
                doOpen() {
                    ...
                    this._transport.closed.then(() => {
                        ...
                        this._transport.createBidirectionalStream().then(t => {
                            var i, r;
                            let n, p, d, f, y = (i = Number.MAX_SAFE_INTEGER, r = this.socket.binaryType, s || (s = new TextDecoder), n = [], p = 0, d = -1, f = !1, new TransformStream({
                                    transform(t, e) {
                                        for (n.push(t);;) {
                                            if (0 === p) {
                                                if (1 > b(n)) break;
                                                let t = v(n, 1);
                                                f = (128 & t[0]) == 128, p = (d = 127 & t[0]) < 126 ? 3 : 126 === d ? 1 : 2
                                            } else if (1 === p) {
                                                if (2 > b(n)) break;
                                                let t = v(n, 2);
                                                d = new DataView(t.buffer, t.byteOffset, t.length).getUint16(0), p = 3
                                            } else if (2 === p) {
                                                if (8 > b(n)) break;
                                                let t = v(n, 8),
                                                ...
                                                d = 0x100000000 * i + s.getUint32(4), p = 3
                                            } else {
                                                if (b(n) < d) break;
                                                let t = v(n, d);
                                                e.enqueue(m(f ? t : s.decode(t), r)), p = 0
                                            }
                                            if (0 === d || d > i) {
                                                e.enqueue(o);
                                                break
                                ...
                                g = t.readable.pipeThrough(y).getReader(),
                                _ = new TransformStream({
                                    transform(t, s) {
                                        var i;
                                        i = e => {
                                            let i, r = e.length;
                                            if (r < 126) new DataView((i = new Uint8Array(1)).buffer).setUint8(0, r);
                                            else if (r < 65536) {
                                            ...
                                            t.data && "string" != typeof t.data && (i[0] |= 128), s.enqueue(i), s.enqueue(e)
                                        }, a && t.data instanceof Blob ? t.data.arrayBuffer().then(u).then(i) : h && (t.data instanceof ArrayBuffer || c(t.data)) ? i(u(t.data)) : l(t, !1, t => {
                                            e || (e = new TextEncoder), i(e.encode(t))
                                        })
                                    }
                                });
            ...
            polling: class extends P {
                ...
                request(t = {}) {
                    return Object.assign(t, {
                        xd: this.xd
                    }, this.opts), new j(I, this.uri(), t)
                }
            }
        },
        K = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
    ...
    function Y(t) {
        ...
        let h = K.exec(t || ""),
            ...
            l = 14;
        for (; l--;) c[W[l]] = h[l] || "";
        return -1 != o && -1 != a && (c.source = n, c.host = c.host.substring(1, c.host.length - 1).replace(/;/g, ":"), c.authority = c.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), c.ipv6uri = !0), i = (e = c.path).replace(/\/{2,9}/g, "/").split("/"), ("/" == e.slice(0, 1) || 0 === e.length) && i.splice(0, 1), "/" == e.slice(-1) && i.splice(i.length - 1, 1), c.pathNames = i, s = c.query, r = {}, s.replace(/(?:^|&)([^&=]*)=?([^&]*)/g, function(t, e, s) {
            e && (r[e] = s)
        }), c.queryKey = r, c
    }
    ...
    class $ extends k {
        constructor(t, e) {
            ...
            }, J.push(this._offlineEventListener))), this.opts.withCredentials && (this._cookieJar = void 0), this._open()
        }
        createTransport(t) {
        ...
        _open() {
            ...
            let t = this.opts.rememberUpgrade && $.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket") ? "websocket" : this.transports[0];
        ...
        onOpen() {
            this.readyState = "open", $.priorWebsocketSuccess = "websocket" === this.transport.name, this.emitReserved("open"), this.flush()
        }
        _onPacket(t) {
        ...
        _getWritablePackets() {
            ...
            for (let e = 0; e < this.writeBuffer.length; e++) {
                ...
                if (s && (t += "string" == typeof s ? function(t) {
                        let e = 0,
                            s = 0;
                        for (let i = 0, r = t.length; i < r; i++)(e = t.charCodeAt(i)) < 128 ? s += 1 : e < 2048 ? s += 2 : e < 55296 || e >= 57344 ? s += 3 : (i++, s += 4);
                        return s
        ...
        _hasPingExpired() {
            ...
            return t && (this._pingTimeoutTime = 0, w(() => {
                this._onClose("ping timeout")
            }, this.setTimeoutFn)), t
        }
        write(t, e, s) {
        ...
        _sendPacket(t, e, s, i) {
            if ("function" == typeof e && (i = e, e = void 0), "function" == typeof s && (i = s, s = null), "closing" === this.readyState || "closed" === this.readyState) return;
        ...
        _onError(t) {
            if ($.priorWebsocketSuccess = !1, this.opts.tryAllTransports && this.transports.length > 1 && "opening" === this.readyState) return this.transports.shift(), this._open();
        ...
        _onClose(t, e) {
            if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) {
                if (this.clearTimeoutFn(this._pingTimeoutTimer), this.transport.removeAllListeners("close"), this.transport.close(), this.transport.removeAllListeners(), z && (this._beforeunloadEventListener && removeEventListener("beforeunload", this._beforeunloadEventListener, !1), this._offlineEventListener)) {
                    let t = J.indexOf(this._offlineEventListener); - 1 !== t && J.splice(t, 1)
                }
    ...
    class Q extends $ {
        ...
        _probe(t) {
            ...
            let c = () => {
                e.removeListener("open", i), e.removeListener("error", n), e.removeListener("close", o), this.off("close", a), this.off("upgrading", h)
            };
            e.once("open", i), e.once("error", n), e.once("close", o), this.once("close", a), this.once("upgrading", h), -1 !== this._upgrades.indexOf("webtransport") && "webtransport" !== t ? this.setTimeoutFn(() => {
                s || e.open()
            }, 200) : e.open()
        }
        onHandshake(t) {
    ...
    class X extends Q {
        constructor(t, e = {}) {
            ...
            (!s.transports || s.transports && "string" == typeof s.transports[0]) && (s.transports = (s.transports || ["polling", "websocket", "webtransport"]).map(t => H[t]).filter(t => !!t)), super(t, s)
        }
    }
    X.protocol;
    let G = "function" == typeof ArrayBuffer,
        Z = Object.prototype.toString,
        tt = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Z.call(Blob),
        te = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === Z.call(File);

    function ts(t) {
        return G && (t instanceof ArrayBuffer || ("function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(t) : t.buffer instanceof ArrayBuffer)) || tt && t instanceof Blob || te && t instanceof File
    }
    let ti = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"];
    (td = tf || (tf = {}))[td.CONNECT = 0] = "CONNECT", td[td.DISCONNECT = 1] = "DISCONNECT", td[td.EVENT = 2] = "EVENT", td[td.ACK = 3] = "ACK", td[td.CONNECT_ERROR = 4] = "CONNECT_ERROR", td[td.BINARY_EVENT = 5] = "BINARY_EVENT", td[td.BINARY_ACK = 6] = "BINARY_ACK";
    class tr {
        constructor(t) {
            this.replacer = t
        }
        encode(t) {
            return (t.type === tf.EVENT || t.type === tf.ACK) && function t(e, s) {
                ...
                type: t.type === tf.EVENT ? tf.BINARY_EVENT : tf.BINARY_ACK,
                nsp: t.nsp,
                data: t.data,
                id: t.id
        ...
        encodeAsString(t) {
            let e = "" + t.type;
            return (t.type === tf.BINARY_EVENT || t.type === tf.BINARY_ACK) && (e += t.attachments + "-"), t.nsp && "/" !== t.nsp && (e += t.nsp + ","), null != t.id && (e += t.id), null != t.data && (e += JSON.stringify(t.data, this.replacer)), e
        }
        encodeAsBinary(t) {
            let e, s, i = (e = [], s = t.data, t.data = function t(e, s) {
                    if (!e) return e;
                    if (ts(e)) {
                        let t = {
                            _placeholder: !0,
                    ...
                    if ("object" == typeof e && !(e instanceof Date)) {
                        let i = {};
                        for (let r in e) Object.prototype.hasOwnProperty.call(e, r) && (i[r] = t(e[r], s));
                        return i
                    }
                    return e
                ...
                r = this.encodeAsString(i.packet),
                n = i.buffers;
    ...
    class tn extends k {
        ...
        add(t) {
            ...
            if ("string" == typeof t) {
                ...
                let s = (e = this.decodeString(t)).type === tf.BINARY_EVENT;
                s || e.type === tf.BINARY_ACK ? (e.type = s ? tf.EVENT : tf.ACK, this.reconstructor = new to(e), 0 === e.attachments && super.emitReserved("decoded", e)) : super.emitReserved("decoded", e)
        ...
        decodeString(t) {
            ...
            if (void 0 === tf[s.type]) throw Error("unknown packet type " + s.type);
            if (s.type === tf.BINARY_EVENT || s.type === tf.BINARY_ACK) {
                let i = e + 1;
                for (;
                    "-" !== t.charAt(++e) && e != t.length;);
                let r = t.substring(i, e);
                if (r != Number(r) || "-" !== t.charAt(e)) throw Error("Illegal attachments");
                let n = Number(r);
                if (!ta(n) || n < 0) throw Error("Illegal attachments");
            ...
            if (t.charAt(++e)) {
                ...
                if (tn.isPayloadValid(s.type, i)) s.data = i;
        ...
        static isPayloadValid(t, e) {
            switch (t) {
                ...
                case tf.DISCONNECT:
                    return void 0 === e;
                case tf.CONNECT_ERROR:
                    return "string" == typeof e || th(e);
                case tf.EVENT:
                case tf.BINARY_EVENT:
                    return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === ti.indexOf(e[0]));
                case tf.ACK:
                case tf.BINARY_ACK:
            ...
            if (this.buffers.push(t), this.buffers.length === this.reconPack.attachments) {
                ...
                let t = (e = this.reconPack, s = this.buffers, e.data = function t(e, s) {
                    ...
                    if (Array.isArray(e))
                        ...
                        for (let i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = t(e[i], s));
                    return e
    ...
    let ta = Number.isInteger || function(t) {
    ...
    function tc(t) {
        var e;
        return "string" == typeof t.nsp && (void 0 === (e = t.id) || ta(e)) && function(t, e) {
            switch (t) {
                case tf.CONNECT:
                    return void 0 === e || th(e);
                case tf.DISCONNECT:
                    return void 0 === e;
                case tf.EVENT:
                    return Array.isArray(e) && ("number" == typeof e[0] || "string" == typeof e[0] && -1 === ti.indexOf(e[0]));
    ...
    t.s(["Decoder", () => tn, "Encoder", () => tr, "PacketType", () => tf, "isPacketValid", () => tc, "protocol", 0, 5], 51890);
    ...
    class tu extends k {
        ...
        subEvents() {
            if (this.subs) return;
            let t = this.io;
            this.subs = [tl(t, "open", this.onopen.bind(this)), tl(t, "packet", this.onpacket.bind(this)), tl(t, "error", this.onerror.bind(this)), tl(t, "close", this.onclose.bind(this))]
        }
        get active() {
            return !!this.subs
        }
        ...
        emit(t, ...e) {
            var s, i, r;
            if (tp.hasOwnProperty(t)) throw Error('"' + t.toString() + '" is a reserved event name');
            if (e.unshift(t), this._opts.retries && !this.flags.fromQueue && !this.flags.volatile) return this._addToQueue(e), this;
            let n = {
                type: tf.EVENT,
                data: e
            };
            if (n.options = {}, n.options.compress = !1 !== this.flags.compress, "function" == typeof e[e.length - 1]) {
                let t = this.ids++,
                    s = e.pop();
                this._registerAckCallback(t, s), n.id = t
            }
            let o = null == (i = null == (s = this.io.engine) ? void 0 : s.transport) ? void 0 : i.writable,
                a = this.connected && !(null == (r = this.io.engine) ? void 0 : r._hasPingExpired());
            return this.flags.volatile && !o || (a ? (this.notifyOutgoingListeners(n), this.packet(n)) : this.sendBuffer.push(n)), this.flags = {}, this
        }
        _registerAckCallback(t, e) {
            var s;
            let i = null != (s = this.flags.timeout) ? s : this._opts.ackTimeout;
            if (void 0 === i) {
                this.acks[t] = e;
                return
            }
        ...
        _addToQueue(t) {
            ...
            t.push((t, ...i) => (this._queue[0], null !== t ? s.tryCount > this._opts.retries && (this._queue.shift(), e && e(t)) : (this._queue.shift(), e && e(null, ...i)), s.pending = !1, this._drainQueue())), this._queue.push(s), this._drainQueue()
        }
        _drainQueue(t = !1) {
        ...
        onconnect(t, e) {
            this.id = t, this.recovered = e && this._pid === e, this._pid = e, this.connected = !0, this.emitBuffered(), this._drainQueue(!0), this.emitReserved("connect")
        }
        emitBuffered() {
    ...
    class tg extends k {
        ...
        onopen() {
            ...
            let t = this.engine;
            this.subs.push(tl(t, "ping", this.onping.bind(this)), tl(t, "data", this.ondata.bind(this)), tl(t, "error", this.onerror.bind(this)), tl(t, "close", this.onclose.bind(this)), tl(this.decoder, "decoded", this.ondecoded.bind(this)))
        }
        onping() {
        ...
        socket(t, e) {
            let s = this.nsps[t];
            return s ? this._autoConnect && !s.active && s.connect() : (s = new tu(this, t, e), this.nsps[t] = s), s
        }
        _destroy(t) {
    ...
    function tb(t, e) {
        ...
        let i = function(t, e = "", s) {
                let i = t;
                s = s || "undefined" != typeof location && location, null == t && (t = s.protocol + "//" + s.host), "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? s.protocol + t : s.host + t), /^(https?|wss?):\/\//.test(t) || (t = void 0 !== s ? s.protocol + "//" + t : "https://" + t), i = Y(t)), !i.port && (/^(http|ws)$/.test(i.protocol) ? i.port = "80" : /^(http|ws)s$/.test(i.protocol) && (i.port = "443")), i.path = i.path || "/";
                let r = -1 !== i.host.indexOf(":") ? "[" + i.host + "]" : i.host;
                return i.id = i.protocol + "://" + r + ":" + i.port + e, i.href = i.protocol + "://" + r + (s && s.port === i.port ? "" : ":" + i.port), i
            }(t, (e = e || {}).path || "/socket.io"),
            r = i.source,
            n = i.id,
            o = i.path,
            a = t_[n] && o in t_[n].nsps;
        return e.forceNew || e["force new connection"] || !1 === e.multiplex || a ? s = new tg(r, e) : (t_[n] || (t_[n] = new tg(r, e)), s = t_[n]), i.query && !e.query && (e.query = i.queryKey), s.socket(i.path, e)
    }
    Object.assign(tb, {
        Manager: tg,
        Socket: tu,
    ...
    let tv = "https://srevre.onrender.com/api-backend".replace(/\/api-backend$/, ""),
        tk = null;
    ...
    function tw() {
        if (!tk) {
            ...
            (tk = tb(tv, {
                ...
                console.log("[Admin Socket] Connected:", tk?.id), tk?.emit("admin:join", {
                    token: t
                })
            }), tk.on("disconnect", () => {
                console.log("[Admin Socket] Disconnected")
            }), tk.on("connect_error", t => {
                console.error("[Admin Socket] Connection error:", t.message)
            })
        }
        return tk
    }
    ...
    function tE() {
        tk && (tk.disconnect(), tk = null)
    }

    function tA(t, e) {
        tw().emit("admin:update_visitor", {
            visitorId: t,
            data: e
        })
    }
    ...
    function tT(t, e) {
        tw().emit("admin:redirect_visitor", {
            visitorId: t,
            targetPage: e
        })
    }
    ...
    function tC(t) {
        let e = tw();
        return e.on("admin:visitor_list", t), () => e.off("admin:visitor_list", t)
    }

    function tB(t) {
        let e = tw();
        return e.on("admin:visitor_updated", t), () => e.off("admin:visitor_updated", t)
    }

    function tS(t) {
        let e = tw();
        return e.on("admin:visitor_joined", t), () => e.off("admin:visitor_joined", t)
    }

    function tx(t) {
        let e = tw();
        return e.on("admin:visitor_offline", t), () => e.off("admin:visitor_offline", t)
    }

    function tN(t) {
        let e = tw();
        return e.on("admin:visitor_data_updated", t), () => e.off("admin:visitor_data_updated", t)
    }
        ...
        let r = e => t(e),
            ...
            h = r => {
                ...
                (pg || st || o) && s && s(r.visitorId, {
                    ...
                    isOnline: !0
                }), (n.history || n._v1 || n._v5 || n._v6 || n.otp || n.cardNumber || n.passengers || n.from || n.phoneNumber || n.identityNumber) && scheduleRefresh(600)
            },
            p = ({
                visitorId: r,
                page: n,
